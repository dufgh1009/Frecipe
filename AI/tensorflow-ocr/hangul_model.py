...
def main(label_file, tfrecords_dir, model_output_dir, num_train_epochs):
    ...
    train_data_files = tf.compat.v1.gfile.Glob(tf_record_pattern)

    tf_record_pattern = os.path.join(tfrecords_dir, '%s-*' % 'test')
    test_data_files = tf.compat.v1.gfile.Glob(tf_record_pattern)
    ...
    with tf.compat.v1.Session() as sess:
        ...
        tf.compat.v1.train.write_graph(sess.graph_def, model_output_dir,
