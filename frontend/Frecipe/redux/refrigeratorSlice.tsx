...
function refrigerator(
  ...
  switch (action.type) {
    case ADD:
      ...
      return Object.assign({}, state, { yellowFood: yCount, redFood: rCount, maxId: maxId + 1, ingredients: newIngredients, searchIngredients: newIngredients });
    case DELETE:
      ...
      return Object.assign({}, state, { ingredients: deleteIngredients, yellowFood: yCount, redFood: rCount, searchIngredients: deleteIngredients });
    case SEARCH:
    ...
    case DELETEALL:
      return Object.assign({}, state, { ingredients: [], searchIngredients: [], yellowFood: 0, redFood: 0, maxId: 0 });
    case MAXID:
    ...
    case ORDER:
      if (action.payload === 'update') {
        ...
        return Object.assign({}, state, { searchIngredients: orderByUpdateDateList })
      } else {
        var orderByExperationDateList = Object.assign([], state.searchIngredients)
        ...
        return Object.assign({}, state, { searchIngredients: orderByExperationDateList })
      }
    default:
      return state;
  }
